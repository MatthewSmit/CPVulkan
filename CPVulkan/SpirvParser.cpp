		...
		case OpTypeVector:
			{
				...
				vecbase.instruction = instruction;
				break;
			}
		...
		case OpTypeMatrix:
			{
				...
				matrixbase.instruction = instruction;
				break;
			}
		...
		case OpTypeArray:
			{
				...
				arraybase.instruction = instruction;
		...
		case OpTypePointer:
			{
				...
				ptrbase.instruction = instruction;
