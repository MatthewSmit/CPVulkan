...
static DXGIFormat ConvertFormat(VkFormat format)
{
	...
	case VK_FORMAT_R8G8B8A8_USCALED: TODO_ERROR();
	case VK_FORMAT_R8G8B8A8_SSCALED: TODO_ERROR();
	...
	case VK_FORMAT_B8G8R8A8_SNORM: TODO_ERROR();
	case VK_FORMAT_B8G8R8A8_USCALED: TODO_ERROR();
	case VK_FORMAT_B8G8R8A8_SSCALED: TODO_ERROR();
	case VK_FORMAT_B8G8R8A8_UINT: TODO_ERROR();
	case VK_FORMAT_B8G8R8A8_SINT: TODO_ERROR();
	...
	case VK_FORMAT_D16_UNORM_S8_UINT: TODO_ERROR();
