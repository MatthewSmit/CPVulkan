...
// template void ConvertPixelsToTemp(const FormatInformation& format, const double input[4], uint64_t output[4]);
// template void ConvertPixelsToTemp(const FormatInformation& format, const int32_t input[4], uint64_t output[4]);
// template void ConvertPixelsToTemp(const FormatInformation& format, const int64_t input[4], uint64_t output[4]);
// template void ConvertPixelsToTemp(const FormatInformation& format, const uint32_t input[4], uint64_t output[4]);
// template void ConvertPixelsToTemp(const FormatInformation& format, const uint64_t input[4], uint64_t output[4]);
//
//
