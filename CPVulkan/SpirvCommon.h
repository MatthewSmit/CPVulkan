...
#include "Spirv.h"
#include "SpirvCrossContainers.h"
#include "SpirvCrossErrorHandling.h"
...
namespace std
{
	template <spirv_cross::Types type>
	struct hash<spirv_cross::TypedID<type>>
	{
		size_t operator()(const spirv_cross::TypedID<type>& value) const
		{
