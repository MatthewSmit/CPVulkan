...
constexpr auto RT_SHADER_GROUP_HANDLE_SIZE = 16;
constexpr auto RT_MAX_RECURSION_DEPTH = 32;
constexpr auto RT_MAX_SHADER_GROUP_STRIDE = 0x10000;
constexpr auto RT_SHADER_GROUP_BASE_ALIGNMENT = 16;
constexpr auto RT_MAX_GEOMETRY_COUNT = 0xFFFFFFFF;
constexpr auto RT_MAX_INSTANCE_COUNT = 0xFFFFFFFF;
constexpr auto RT_MAX_TRIANGLE_COUNT = 0xFFFFFFFF;
constexpr auto RT_MAX_DESCRIPTOR_SET_ACCELERATION_STRUCTURES = 0x10000;
